...
class _HomeScreenState extends State<HomeScreen> {
  ...
  @override
  void initState() {
    dataState.getWeatherByName("patiala");
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<Weather>(
        future: isDefault
            ? dataState.getWeatherByName(defaultCity)
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                RaisedButton.icon(
                                  ...
                                  elevation: 2.0,
                                  icon:isDefault? Icon(Icons.location_on,
                                      color: Colors.orange):
                                  Icon(Icons.location_on,
                                      color: Colors.red),
                                  label:isDefault ? Text("GET LOCATION"): Text("MY LOCATION"),
                                  color: Colors.yellow,
